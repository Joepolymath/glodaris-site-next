      ...
      <div className="lg:py-16 py-4">
        ...
        <div className="max-w-7xl mx-auto px-8 sm:px-6 font-mono lg:px-8 mt-2 lg:mt-4">
          <ul className="list-disc text-gray-700 text-sm lg:text-lg mb-6 font-light tracking-wide ">
            ...
            <li>Identify, Train, and Coach a Core Team of internal change agents.</li>
            <li>Develop internal group of individuals who will lead the change and become coaches, teachers, and facilitators.</li>
            <li>Select and improve key pilot areas through kaizen activities and projects</li>
            <li>
            ...
            <li>Identify needed kaizen activities and daily kaizen targets through VSM and a 4-6 month detailed plan.</li>
            <li>Perform team kaizen activities and projects to execute VSM plans.</li>
            <li>Create lean value streams. Develop internal problem solving capabilities for daily kaizen and daily management</li>
            <li>Train Operations front-line employees and supervisors with a “Lean 101” course</li>
        ...
        <div className="max-w-7xl font-mono mx-auto px-8 sm:px-6 lg:px-8 mt-2 lg:mt-4">
          <ul className="list-disc text-gray-700 text-sm lg:text-lg mb-6 font-light tracking-wide ">
            ...
            <li>Build a larger internal knowledge base of individuals who will become coaches, teachers, and facilitators.</li>
            ...
            <li>Perform team kaizen activities and projects to execute VSM plans.</li>
            <li>Create lean support value streams. Develop internal problem solving capabilities for daily kaizen and daily mgmt.</li>
            <li>Perform Value Stream Mapping and kaizen activities on additional core value streams.</li>
            <li>Identify and execute kaizen activities based on VSM.</li>
            <li>Train Support Function employees and supervisors with a “Lean 101” course</li>
            <li>Begin to drive change where the work happens for support / administrative functions.</li>
